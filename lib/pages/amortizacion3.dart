...
import 'package:cobrax/services/amortizacion3_servicio.dart';
import 'package:cobrax/widgets/ventana_datos.dart';
import 'package:flutter/material.dart';

void main() => runApp(const Amortizacion3());

class Amortizacion3 extends StatefulWidget {
  const Amortizacion3({super.key});

  @override
  State<Amortizacion3> createState() => _Amortizacion3State();
}

class _Amortizacion3State extends State<Amortizacion3> {
  var db = Amortizacion3Data();
  ...
  Column listaInversion(data) {
    return Column(
      children: [
        ...
        datoInversion("Retencion: ", "${data["retencion"]}"),
